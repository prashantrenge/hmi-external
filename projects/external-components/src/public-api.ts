...
export * from './lib/primeng-selectors/components/generate-with-ai/generate-with-ai.component';export * from './lib/primeng-selectors/components/test-component-external/test-component-external.component.ts';