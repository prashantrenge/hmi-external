import { CalendarComponent } from './components/calendar-external/calendar-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, CalendarComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, CalendarComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
