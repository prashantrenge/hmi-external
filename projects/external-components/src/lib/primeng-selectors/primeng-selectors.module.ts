import { TestCalendarComponent } from './components/test-calendar-external/test-calendar-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, TestCalendarComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, TestCalendarComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
