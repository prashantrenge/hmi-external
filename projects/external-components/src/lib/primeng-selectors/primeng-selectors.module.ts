import { ReminderComponent } from './components/reminder-external/reminder-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, ReminderComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, ReminderComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
