import { ShaktiComponent } from './components/Shakti-external/Shakti-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, ShaktiComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, ShaktiComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
