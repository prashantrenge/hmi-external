import { FullCalendarComponent } from './components/full-calendar-external/full-calendar-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, FullCalendarComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, FullCalendarComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
