import { SigmaComponent } from './components/Sigma-external/Sigma-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, SigmaComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, SigmaComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
